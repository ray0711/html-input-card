...
import { TimeInputCardConfig } from './types';
...
@customElement('timeinput-card-editor')
export class TimeInputCardEditor extends ScopedRegistryHost(LitElement) implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;

  @state() private _config?: TimeInputCardConfig;
